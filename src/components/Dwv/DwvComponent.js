...
class DwvComponent extends React.Component {
	...
	componentDidMount() {
		...
		// loading dicom from url
		app.loadURLs([
			"https://tudotechprojects.s3.ap-southeast-1.amazonaws.com/bbmri-53323851.dcm",
		]);
		// store
		...
		// dwv.utils.loadFromUri(
		// 	"https://petscape-root-bucket.s3.ap-south-1.amazonaws.com/0002.DCM",
		// 	app
		// );
	...
	onDrop = (event: DragEvent) => {
		...
		// const file =
		// 	"/media/naruto/New Volume/Tudo job files/ivmartel-dwv-react-62d651b/public/assets/0002.DCM";
		...
		// this.state.dwvApp.loadFiles(
		// 	"https://petscape-root-bucket.s3.ap-south-1.amazonaws.com/0002.DCM"
		// );

		// console.log(this.state.dwvApp);
		this.state.dwvApp.loadURLs([
			"https://tudotechprojects.s3.ap-southeast-1.amazonaws.com/bbmri-53323851.dcm",
		]);
		// localStorage.setItem("dicom")
